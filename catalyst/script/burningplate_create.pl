...
pod2usage(1) unless $helper->mk_component( 'BurningPlate', @ARGV );

1;

=head1 NAME

burningplate_create.pl - Create a new Catalyst Component

=head1 SYNOPSIS

burningplate_create.pl [options] model|view|controller name [helper] [options]
